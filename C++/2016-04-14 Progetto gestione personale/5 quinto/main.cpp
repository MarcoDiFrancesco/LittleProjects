...
///CALCOLO TEMPO DI MATTINA
        ...
        else if(oraIngressoMattina[personaDaAnalizzare][w]==9)
        {
            ...
            else if(minutoIngressoMattina[personaDaAnalizzare][w]<=5){minutiLavoroMattina[personaDaAnalizzare][w]=minutiLavoroMattina[personaDaAnalizzare][w]+(minutoUscitaMattina[personaDaAnalizzare][w]-30);}
